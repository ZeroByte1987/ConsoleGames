namespace ASCII_Tactics.Config
{
	...
	public static class MapConfig
	{
		...
		public static Range	FurnitureCount		= new Range(0, 10);
		...
		public static List<TileType> TileSet = new List<TileType>
			...
			new TileType(2, "Table",		TileRole.None, (char)178,	Color.DarkCyan,	Color.Black, ObjectSize.FullTile,	ObjectHeight.Half, false),
		};
	}
}